...
function library:Introduction()
    ...
    xsxLogo.Image = "https://create.roblox.com/store/asset/8922788427/Lunar"
    ...
    hashLogo.Image = "https://create.roblox.com/store/asset/8922788427/Lunar"
    ...
    CreateTween("Rotation", 0)
    local MinusAmount = -16
    coroutine.wrap(function()
        while wait() do
            MinusAmount = MinusAmount + 0.4
            TweenService:Create(xsxLogo, TweenTable["Rotation"], {Rotation = xsxLogo.Rotation - MinusAmount}):Play()
        end
    end)()
